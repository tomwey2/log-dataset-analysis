...
#$KAFKA_HOME/bin/kafka-topics.sh --create --topic random-strings --bootstrap-server localhost:9092
#$KAFKA_HOME/bin/kafka-topics.sh --create --topic tall-random-strings --bootstrap-server localhost:9092
